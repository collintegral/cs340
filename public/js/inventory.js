...
function buildInventoryList(data) {
    ...
    data.forEach(element => {
        ...
        dataTable += `<td class="submit-cont"><a href='/inv/edit/${element.inv_id}' class="button inv-button" title='Click to Update'>Modify</a></td>`;
        dataTable += `<td class="submit-cont"><a href='/inv/delete/${element.inv_id}' class="button inv-button" title='Click to Delete'>Delete</a></td></tr>`;
    });
    dataTable += '</tbody>';
