...
async function updateInventory(inv_id, inv_make, inv_model, inv_year, inv_miles, inv_price, inv_color, inv_description, classification_id) {
    try {
        const sql = "UPDATE inventory SET inv_make=$1, inv_model=$2, inv_year=$3, inv_miles=$4, inv_price=$5, inv_color=$6, inv_description=$7, classification_id=$8 WHERE inv_id=$9 RETURNING *";
...
module.exports = {getClassifications, getInventoryByClassificationId, getInventoryByInvId, checkExistingClass, newClassification, newInventory, updateInventory, deleteInventory};